...
TEST_CASE("SubNamespace")
{
  ...
  const auto full_ns = Namespace(SubNamespace{}.extend(0x0001020304050607, 64)
...
TEST_CASE("Namespace Config")
{
  ...
  REQUIRE(namespaces.welcome_pub() == Namespace("0x000102030405060700a0a1a200000000/96"));
  REQUIRE(namespaces.group_pub() == Namespace("0x000102030405060701a0a1a200000000/96"));
